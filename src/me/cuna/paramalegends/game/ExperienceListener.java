...
public class ExperienceListener implements Listener {
    ...
    public void playerKill(Player player, LivingEntity entity, @Nullable ClassGameType skill){
    ...
    public void addExp(@Nullable Player player, ClassGameType skilltype, int amount){
        addExp(player, skilltype, amount, 0);
    }

    // Add exp to player and check if player levelled up
    public void addExp(@Nullable Player player, ClassGameType skillType, int amount, int lectrum){
